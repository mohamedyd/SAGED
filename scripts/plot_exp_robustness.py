# Plot robustness analysis (error rate & outlier degree) 
...
def plot_exp_robustness(results_paths, plots_path, eval_metrics, y_labels, plot_outlier_degree=False):
    ...
    for plot_path, eval_metric, y_label in zip(plots_path, eval_metrics, y_labels):
        ...
        for idx in range(len(labels_list)):
            ...
            x_axis_values = [x for x in results_dict[label][0]]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--evaluate-outlier-degree', action="store_true", default=False, help="plot outlier degree experiment")
    ...
    for dataset_name in dataset_names:
        ...
        exp_name = ExperimentName.OUTLIER_DEGREE.__str__() if args.evaluate_outlier_degree else ExperimentName.ERROR_RATE.__str__()
        ...
        plot_exp_robustness(results_paths=results_paths,
                            ...
                            y_labels=y_labels,
                            plot_outlier_degree=args.evaluate_outlier_degree)