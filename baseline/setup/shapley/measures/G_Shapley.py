...
import numpy as np
import scipy
from baseline.setup.shapley.utils.Shapley import ShapNN
    ...
    def score(
        ...
        for iteration in range(iterations):
            ...
            if 10 * (iteration + 1) / iterations % 1 == 0:
                print(
                    "{} out of {} G-Shapley iterations".format(
            ...
            idxs_g = np.concatenate(
                [idxs_g, np.reshape(model.history["idxs"][0], (1, -1))]
            )
